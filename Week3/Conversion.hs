...
reorder (Cnj (n : xs)) x = 									-- For the form each element n, start swapping n and x + The form Cnj re evaluate
  Cnj [reorder n x, reorder (Cnj xs) x]		
reorder n (Cnj (x : xs)) = 									-- For the form each element x, start swapping x and n + The form Cnj re evaluate
  Cnj [reorder n x, reorder n (Cnj xs)]		
